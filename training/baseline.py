...
def compute_baseline_metrics():
    ...
    X_train, X_test, y_train, y_test = train_test_split(actual, predicted, test_size=0.2, random_state=42, shuffle=False)
    ...
    nrmse = (rmse / X_test.max()) * 100
    return rmse, mae, r2_train, r2_test, nrmse

def skill_score(rmse_model, rmse_baseline):
    return 1 - (rmse_model/rmse_baseline)

if __name__=="__main__":
    rmse, mae, r2_train, r2_test, nrmse = compute_baseline_metrics()
