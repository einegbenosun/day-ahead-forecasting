...
df = pd.read_csv(csv_path, sep=",", skiprows=3)
print(df.head())
...
open_meteo_df = df[["time", "temperature_2m (°C)", "relative_humidity_2m (%)", "wind_speed_10m (km/h)", "shortwave_radiation (W/m²)", "direct_radiation (W/m²)", "direct_normal_irradiance (W/m²)", "diffuse_radiation (W/m²)", "is_day ()", "sunshine_duration (s)"]]
...
open_meteo_df.to_csv("ingestion/csv/open_meteo_cleaned.csv", index=False)
